...
Download_SSR(){
	...
	wget -N --no-check-certificate "https://raw.githubusercontent.com/ccj2012/shadowsocksr/master/manyuser.zip"	
...
Service_SSR(){
	if [[ ${release} = "centos" ]]; then
		if ! wget --no-check-certificate https://raw.githubusercontent.com/ccj2012/shadowsocksr/master/ssr_centos -O /etc/init.d/ssr; then
